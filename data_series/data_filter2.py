...
names_series = pd.Series(namesList)
energy2010_series = pd.Series(energy2010List)
energy2012_series = pd.Series(energy2012List)

mean2010 = energy2010_series.sum()/len(energy2010_series)
mean2012 = energy2012_series.sum()/len(energy2012_series)
print(mean2010)
print(mean2012)
filterAboveMean2010 = energy2010_series > mean2010
filterAboveMean2012 = energy2012_series > mean2012
print(filterAboveMean2010 )
print(filterAboveMean2012 )
print(names_series.where(filterAboveMean2010 & filterAboveMean2012).dropna())
